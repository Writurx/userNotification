...
class NotificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notification" do
    assert_difference('Notification.count') do
      post notifications_url, params: { notification: { shablon: @notification.shablon, textCode: @notification.textCode, type: @notification.type } }
    end
  ...
  test "should update notification" do
    patch notification_url(@notification), params: { notification: { shablon: @notification.shablon, textCode: @notification.textCode, type: @notification.type } }
